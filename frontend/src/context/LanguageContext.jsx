...
const translations = {
  vi: {
    ...
    countdown_tab_presets: "Kỳ thi chính thức",
    countdown_tab_custom: "Bộ đếm của bạn",
    countdown_presets_desc: "Chọn một kỳ thi có sẵn để theo dõi. Lịch thi được hệ thống tự động kiểm tra và cập nhật khi có thông báo chính thức.",
  ...
  en: {
    ...
    countdown_tab_presets: "Official Exams",
    countdown_tab_custom: "Your Countdowns",
    countdown_presets_desc: "Select a preset exam to track. Exam schedules are automatically verified and updated from official sources.",
  ...
  zh: {
    ...
    countdown_tab_presets: "官方正式考试",
    countdown_tab_custom: "您的倒计时",
    countdown_presets_desc: "选择预设考试进行追踪。系统将自动从官方来源验证并更新考试日程。",
