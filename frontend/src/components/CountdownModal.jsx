...
import { X, Plus, Check, Trash2, Calendar, Bell, ExternalLink, ShieldCheck } from 'lucide-react';
                  ...
                  return (
                    ...
                    >
                      <div className="min-w-0 flex-1 space-y-1.5">
                        ...
                        {/* Badges Row - Clean inline wrap without stretching */}
                        ...
                        <p className="text-xs text-slate-400 line-clamp-2">{examDesc}</p>
                ...
                {!isFormOpen ? (
                  ...
                  <form onSubmit={handleSubmitCustom} className="space-y-4 bg-slate-950/60 border border-slate-800 p-4 rounded-xl">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <label htmlFor="emailNotify" className="text-xs text-slate-300">
